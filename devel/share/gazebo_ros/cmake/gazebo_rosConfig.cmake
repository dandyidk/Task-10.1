...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_ros_SOURCE_PREFIX /home/dandy/task-10.1/src/gazebo_ros_pkgs/gazebo_ros)
  set(gazebo_ros_DEVEL_PREFIX /home/dandy/task-10.1/devel)
  ...
  set(gazebo_ros_INSTALL_PREFIX /home/dandy/task-10.1/install)
...
if(NOT "/home/dandy/task-10.1/devel/include;/usr/include " STREQUAL " ")
  set(gazebo_ros_INCLUDE_DIRS "")
  set(_include_dirs "/home/dandy/task-10.1/devel/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dandy/task-10.1/src/gazebo_ros_pkgs/gazebo_ros/${idir}'.  ${_report}")
    endif()
