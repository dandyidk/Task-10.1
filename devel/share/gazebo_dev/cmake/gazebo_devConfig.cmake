...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_dev_SOURCE_PREFIX /home/dandy/task-10.1/src/gazebo_ros_pkgs/gazebo_dev)
  set(gazebo_dev_DEVEL_PREFIX /home/dandy/task-10.1/devel)
  ...
  set(gazebo_dev_INSTALL_PREFIX /home/dandy/task-10.1/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_dev' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dandy/task-10.1/src/gazebo_ros_pkgs/gazebo_dev/${idir}'.  ${_report}")
    endif()
...
set(pkg_cfg_extras "/home/dandy/task-10.1/src/gazebo_ros_pkgs/gazebo_dev/cmake/gazebo_dev-extras.cmake")
